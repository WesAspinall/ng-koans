...
angular
  ...
  // accessing native dom element (var upload)
  // and establishing an area to drag a file in

  // ctrl -> link -> navtive dom (not angular) 
  // -> $scope.$apply() (tell ng that something's changed-> update ctrl 
