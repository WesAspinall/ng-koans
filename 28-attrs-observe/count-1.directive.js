...
angular
  .module('app')
  .directive('counter1', counter1);


  //$attrs.$observe doesn't actually set a watcher
  //so that's a performance benefit over $scope.$watch
  // Note: can't pass model values into 